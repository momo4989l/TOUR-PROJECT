...
<!-- Bootstrap Core CSS -->
<link href="static/css/index/bootstrap.css" rel="stylesheet"
	type="text/css">
<link href="https://fonts.googleapis.com/css?family=East+Sea+Dokdo"
	rel="stylesheet">

<!-- Vitality Theme CSS -->
<link href="static/css/index/vitality-red.css" rel="stylesheet"
	type="text/css">
...
<body>
	<div class="demo-header">
		<!-- <a href="static/login.jsp"><img src="static/img/index/login.jpg"
			class="login-image" align="right" alt="" /></a> -->
		<ul>
			<li style="text-align: right;"><a href="/login"><button>LOGIN & REGISTER</button></a></li>
			<li style="text-align: left; padding-top : 80px;"><img
				src="static/img/header-image.png" /></li>
	...
	<div class="container" id="previews">
		<div class="row content-row">
			...
			<div class="col-md-4">
				<div class="preview-pane">
					<a href="/places"> <img src="static/img/index/map-info.png"
						class="img-responsive img-centered" alt="">
						<h3>Places</h3>
						<hr class="colored">
						<p class="text-muted">Ideal For:</p>
			...
			<div class="col-md-4">
				<div class="preview-pane">
					<a href="/mypage"> <img
						src="static/img/index/planner.png"
						class="img-responsive img-centered" alt="">
